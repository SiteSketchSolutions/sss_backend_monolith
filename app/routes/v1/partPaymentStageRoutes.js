...
let routes = [
    {
        ...
        joiSchemaForSwagger: {
            body: {
                ...
                referenceId: Joi.string().required().description("Enter payment reference id"),
                invoiceNo: Joi.string().required().description("Enter invoice no")
            },
    ...
    },
    {
        ...
        joiSchemaForSwagger: {
            body: {
                ...
                invoiceNo: Joi.string().description("Enter invoice no")
            },
            group: "PartPaymentStage",
